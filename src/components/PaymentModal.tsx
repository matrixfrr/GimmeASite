    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div className="relative bg-card border border-border rounded-2xl p-8 max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-slideIn">
        ...
        <div className="flex items-start gap-2 bg-primary/8 border border-primary/20 rounded-lg px-3 py-2.5 mb-4 text-xs text-muted-foreground">
          ...
          <span>Make sure to fill out the{" "}<button type="button" onClick={() => { onClose(); setTimeout(() => { document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }); }, 150); }} className="text-primary font-semibold underline underline-offset-2 hover:text-primary/80 transition-colors cursor-pointer bg-transparent border-none p-0">contact form</button>{" "}before paying so we know what you need!</span>
        </div>
        {/* Email Input */}
